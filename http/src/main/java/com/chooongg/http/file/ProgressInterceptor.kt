...
import com.chooongg.http.getFileName
import com.chooongg.http.getTag
...
class ProgressInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        //取出进度回调参数
        val upProgressCallback = request.getTag<UploadProgressCallback>()
        val dlProgressCallback = request.getTag<DownloadProgressCallback>()
        //取出文件参数
