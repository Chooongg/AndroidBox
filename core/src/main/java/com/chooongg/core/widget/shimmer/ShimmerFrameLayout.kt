...
class ShimmerFrameLayout @JvmOverloads constructor(
    ...
    init {
        ...
        shimmerAngle = a.getInteger(R.styleable.ShimmerFrameLayout_shimmer_angle, DEFAULT_ANGLE)
        shimmerAnimationDuration = a.getInteger(
            R.styleable.ShimmerFrameLayout_shimmer_animation_duration,
            DEFAULT_ANIMATION_DURATION
        )
        shimmerColor = a.getColor(
            R.styleable.ShimmerFrameLayout_shimmer_color,
            resourcesColor(R.color.surface)
        )
        autoStart = a.getBoolean(R.styleable.ShimmerFrameLayout_shimmer_auto_start, true)
        maskWidth = a.getFloat(R.styleable.ShimmerFrameLayout_shimmer_mask_width, 0.5f)
        gradientCenterColorWidth =
            a.getFloat(R.styleable.ShimmerFrameLayout_shimmer_gradient_center_color_width, 0.1f)
        isAnimationReversed =
            a.getBoolean(R.styleable.ShimmerFrameLayout_shimmer_reverse_animation, false)
        a.recycle()
