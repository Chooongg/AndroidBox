...
class ShimmerConstraintLayout @JvmOverloads constructor(
    ...
    init {
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.ShimmerConstraintLayout, 0, 0)
        shimmerAngle =
            a.getInteger(R.styleable.ShimmerConstraintLayout_shimmer_angle, DEFAULT_ANGLE)
        shimmerAnimationDuration = a.getInteger(
            R.styleable.ShimmerConstraintLayout_shimmer_animation_duration,
            DEFAULT_ANIMATION_DURATION
        )
        shimmerColor = a.getColor(
            R.styleable.ShimmerConstraintLayout_shimmer_color,
            resourcesColor(R.color.divider)
        )
        autoStart = a.getBoolean(R.styleable.ShimmerConstraintLayout_shimmer_auto_start, true)
        maskWidth = a.getFloat(R.styleable.ShimmerConstraintLayout_shimmer_mask_width, 0.5f)
        gradientCenterColorWidth = a.getFloat(
            R.styleable.ShimmerConstraintLayout_shimmer_gradient_center_color_width,
            0.1f
        )
        isAnimationReversed =
            a.getBoolean(R.styleable.ShimmerConstraintLayout_shimmer_reverse_animation, false)
        a.recycle()
