...
class SmoothCheckBox @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr),
    Checkable {
    ...
    init {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, dp2px(0f))
        isChecked = ta.getBoolean(R.styleable.SmoothCheckBox_color_checked, false)
        ta.recycle()
