...
class XEditText constructor(
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        mClearResId = a.getResourceId(
            R.styleable.XEditText_x_clearDrawable,
            R.drawable.ic_edit_clear
        )
        togglePwdDrawableEnable =
            a.getBoolean(R.styleable.XEditText_x_togglePwdDrawableEnable, true)
        mShowPwdResId = a.getResourceId(
            R.styleable.XEditText_x_showPwdDrawable,
            R.drawable.ic_show_password
        )
        mHidePwdResId = a.getResourceId(
            R.styleable.XEditText_x_hidePwdDrawable,
            R.drawable.ic_hide_password
        )
        mClearDrawableTint =
            if (a.hasValue(R.styleable.XEditText_x_clearDrawableTint)) {
                a.getColorStateList(R.styleable.XEditText_x_clearDrawableTint)
            } else {
                ColorStateList.valueOf(currentHintTextColor)
            }
        if (mShowPwdResId == R.drawable.ic_show_password &&
            mHidePwdResId == R.drawable.ic_hide_password
        ) {
            // didn't customize toggle pwd drawables
            mTogglePwdDrawableTint =
                if (a.hasValue(R.styleable.XEditText_x_togglePwdDrawableTint)) {
                    a.getColorStateList(R.styleable.XEditText_x_togglePwdDrawableTint)
                } else {
                    ColorStateList.valueOf(currentHintTextColor)
                }
        } else {
        ...
        mInteractionPadding =
            a.getDimensionPixelSize(
                R.styleable.XEditText_x_interactionPadding,
                DEFAULT_PADDING
            )
        a.recycle()
        if (mSeparator == null) {
