    ...
    companion object {
        ...
        fun create(view: TextView, attrs: AttributeSet? = null, defStyle: Int = 0) {
            ...
            if (attrs != null) {
                ...
                var minTextSize = helper.minTextSize
                ...
                enable = a.getBoolean(R.styleable.AutoSizeTextView_ast_autoSizeEnable, enable)
                minTextSize =
                    a.getDimension(R.styleable.AutoSizeTextView_ast_minTextSize, minTextSize)
                precision = a.getFloat(R.styleable.AutoSizeTextView_ast_precision, precision)
                a.recycle()

                helper.minTextSize = minTextSize
